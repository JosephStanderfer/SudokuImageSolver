...
#                    plt.show()
    ...
    def predictDigitValues(self, digitDict):
        ...
        #convnet = load_model('DigitRecogitionConvnet.h5')
        convnet = load_model('printedDigitRecogConvnet.h5')
        #convnet = load_model('TenEpochDigitRecogitionConvnet.h5')
...
if __name__ == '__main__':
    #work:
    #image = cv2.imread('images\\airplaneSudoku.jpg')
    #image = cv2.imread('images\\unseen.png')
    #image = cv2.imread('images\\unseen3.png')
    image = cv2.imread('images\\unseen4.png')
    #image = cv2.imread('images\\sudokusmall.jpg')
    #image = cv2.imread('images\\sudoku1.png')
    #image = cv2.imread('images\\AAeasy.jpg')
    #image = cv2.imread('images\\AAmedium.jpg')
    #image = cv2.imread('images\\AAhard.jpg')
    
    #don't work:
    #image = cv2.imread('images\\unseen2.png')
    # get(6) real(8)
